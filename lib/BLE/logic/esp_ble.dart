...
class Espnetvana {
  ...
  //TIMERS
  // Future<void> EspUpdate() async {
  //   switch (datky.appsync) {
  //     case FIGMA.FLUTTER_ESSENTIALS:
  //       Uint8List input1 = await UniversalBle.readValue(datky.Device_UUID,
  //           FIGMA.ESP32_SERVICE_ID, FIGMA.ESP32_SERVICE_FAVAL);
  //       debugPrint("FLUTTER_ESSEN${String.fromCharCodes(input1)}");
  //       funcy.Show_Snackbar(
  //           "'Code is : '${String.fromCharCodes(input1)}", 5000);
  //       break;
  //     case FIGMA.FLUTTER_SPELCO:
  //       Uint8List input2 = await UniversalBle.readValue(datky.Device_UUID,
  //           FIGMA.ESP32_SERVICE_ID, FIGMA.ESP32_SERVICE_FBVAL);
  //       debugPrint("FLUTTER_SPELCO${String.fromCharCodes(input2)}");
  //       funcy.Show_Snackbar(
  //           "'Code is : '${String.fromCharCodes(input2)}", 5000);
  //       break;
  //     case FIGMA.FLUTTER_SMARTTIMER:
  //       try {
  //         Uint8List input3 = await UniversalBle.readValue(datky.Device_UUID,
  //                 FIGMA.ESP32_SERVICE_ID, FIGMA.ESP32_SERVICE_FCVAL)
  //             .timeout(const Duration(seconds: 5));
  //         debugPrint("FLUTTER_SMARTTIMER${String.fromCharCodes(input3)}");
  //         funcy.Show_Snackbar(
  //             "Code is : ${String.fromCharCodes(input3)}", 5000);
  //         funcy.Set_TEST_DATA(input3.toString());
  //       } catch (e) {
  //         funcy.Set_TEST_DATA(e.toString());
  //         funcy.Show_Snackbar("Error is : ${e.toString()}", 5000);
