                              ...
                              children: [
                                Padding(
                                  ...
                                  child: EasyContainer(
                                    ...
                                    onTap: () async {
                                      try {
                                        final userData = await NetClass()
                                            .getUser(
                                              CacheService.instance.token!,
                                            );

                                        final devices =
                                            (userData!['devices'] as List)
                                                .map(
                                                  (d) => Device(
                                                    id: d['id'],
                                                    macAddress:
                                ...
                                shadows: [
                                  Shadow(
                                    color: Colors.black.withOpacity(
                                      0.5,
                                    ), // Stroke color (adjustable)
                                    offset: const Offset(
                                      1,
                                      1,
                                    ), // Small offset for stroke effect
                                    blurRadius:
                                        1, // Small blur for smooth stroke
                                  ),
                                  Shadow(
                                    ...
                                    offset: const Offset(
                                      -1,
                                      -1,
                                    ), // Opposite direction for full outline
                                    blurRadius: 1,
                                  ),
                                  Shadow(
                                    color: Colors.black.withOpacity(0.5),
