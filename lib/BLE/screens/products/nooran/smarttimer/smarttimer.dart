...
//                       style: const TextStyle(
//                           fontSize: 48.sp, fontFamily: FIGMA.abreb)),
...
//   TextStyle myStyle = const TextStyle(fontFamily: FIGMA.abreb, fontSize: 48.sp);
//   @override
//   Widget build(BuildContext context) {
//     final value = Provider.of<ProvData>(context, listen: false);
...
//                 const Text(
//                   "تایمر",
//                   style: TextStyle(fontFamily: FIGMA.abrlb, fontSize: 24.sp),
//                 ),
//                 EasyContainer(
//                   color: Colors.white,
//                   showBorder: true,
