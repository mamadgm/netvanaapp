              ...
              tabs: [
                GButton(
                  ...
                  leading: SvgPicture.asset(
                    "assets/Home.svg",
                    color: value.Current_screen == 0 ? FIGMA.Prn2 : FIGMA.Gray3,
                  ),
                  text: "خانه",
                  textStyle: TextStyle(
                ...
                GButton(
                  ...
                  leading: SvgPicture.asset(
                    "assets/Effects.svg",
                    color: value.Current_screen == 1 ? FIGMA.Prn2 : FIGMA.Gray3,
                  ),
                  text: "افکت ها",
                  textStyle: TextStyle(
                    fontFamily: FIGMA.estbo,
                ...
                GButton(
                  ...
                  leading: SvgPicture.asset(
                    "assets/Netvana.svg",
                    color: value.Current_screen == 2 ? FIGMA.Prn2 : FIGMA.Gray3,
                  ),
                  text: "نت وانا",
                  textStyle: TextStyle(
                    fontFamily: FIGMA.estbo,
                ...
                GButton(
                  ...
                  leading: SvgPicture.asset(
                    "assets/Setting.svg",
                    color: value.Current_screen == 3 ? FIGMA.Prn2 : FIGMA.Gray3,
                  ),
                  text: "تنظیمات",
                  textStyle: TextStyle(
                    fontFamily: FIGMA.estbo,
